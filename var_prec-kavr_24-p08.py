...
exp_runner_instance.run_experiments([var_precision_alg_exp_kavr24_can],MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,"var_precision",VERBOSE)
exp_runner_instance.run_experiments([var_precision_alg_exp_kavr24_gen],MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,"var_precision",VERBOSE)
