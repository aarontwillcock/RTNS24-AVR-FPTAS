...
# exp_runner_instance.run_experiments([var_precision_alg_exp_row17_p5_can],MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,"var_precision_mem",VERBOSE)
# exp_runner_instance.run_experiments([var_precision_alg_exp_kavr18_p5_can],MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,"var_precision_mem",VERBOSE)
exp_runner_instance.run_experiments([var_precision_alg_exp_kavr24_p5_can],MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,"var_precision_mem",VERBOSE)
# exp_runner_instance.run_experiments([var_precision_alg_exp_exact_can],MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,"var_precision_mem",VERBOSE)
# exp_runner_instance.run_experiments([var_precision_alg_exp_apx_can],MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,"var_precision_mem",VERBOSE)
# exp_runner_instance.run_experiments([var_precision_alg_exp_row17_p5_gen],MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,"var_precision_mem",VERBOSE)
# exp_runner_instance.run_experiments([var_precision_alg_exp_kavr18_p5_gen],MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,"var_precision_mem",VERBOSE)
# exp_runner_instance.run_experiments([var_precision_alg_exp_kavr24_p5_gen],MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,"var_precision_mem",VERBOSE)
# exp_runner_instance.run_experiments([var_precision_alg_exp_exact_gen],MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,"var_precision_mem",VERBOSE)
# exp_runner_instance.run_experiments([var_precision_alg_exp_apx_gen],MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,"var_precision_mem",VERBOSE)