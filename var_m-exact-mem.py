...
var_m_alg_exp_row17_p5_set = [-1]*len(VAR_M_SETS)
var_m_alg_exp_kavr18_p5_set = [-1]*len(VAR_M_SETS)
var_m_alg_exp_kavr24_p5_set = [-1]*len(VAR_M_SETS)
var_m_alg_exp_exact_set = [-1]*len(VAR_M_SETS)
var_m_alg_exp_apx_set = [-1]*len(VAR_M_SETS)


for i in range(len(VAR_M_SETS)):

    var_m_alg_exp_row17_p5_set[i] = exp_task.ExperimentTask("row17",alg_params_p5,var_m_task_sets[i],alg_delta_set,VERBOSE)
    var_m_alg_exp_kavr18_p5_set[i] = exp_task.ExperimentTask("kavr18",alg_params_p5,var_m_task_sets[i],alg_delta_set,VERBOSE)
    var_m_alg_exp_kavr24_p5_set[i] = exp_task.ExperimentTask("kavr24",alg_params_p5,var_m_task_sets[i],alg_delta_set,VERBOSE)
    var_m_alg_exp_exact_set[i] = exp_task.ExperimentTask("exact",alg_params_p12,var_m_task_sets[i],alg_delta_set,VERBOSE)
    var_m_alg_exp_apx_set[i] = exp_task.ExperimentTask("apx",alg_params_p12,var_m_task_sets[i],alg_delta_set,VERBOSE)
...
# exp_runner_instance.run_experiments(var_m_alg_exp_row17_p5_set,MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,EXPERIMENT_NAME,VERBOSE)
# exp_runner_instance.run_experiments(var_m_alg_exp_kavr18_p5_set,MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,EXPERIMENT_NAME,VERBOSE)
...
exp_runner_instance.run_experiments(var_m_alg_exp_exact_set,MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,EXPERIMENT_NAME,VERBOSE)
# exp_runner_instance.run_experiments(var_m_alg_exp_apx_set,MAKE_DBF_LOG_FILE,MAKE_EXP_LOG_FILE,MAKE_AGG_LOG_FILE,EXPERIMENT_NAME,VERBOSE)
